...
NewVersion.prototype.setKV = function(key, value) {
    ...
    this._KVs[key] = value;
    var V_bits = sjcl.codec.base64.toBits(JSON.stringify(value));
...
NewVersion.prototype.setKEV = function(key, encryptedValue) {
    ...
    var V_bits = pcrypto.decryptKEV(this._key, EV_bits);
    var V_obj = JSON.parse(sjcl.codec.base64.fromBits(V_bits));
    this._KVs[key] = V_obj;
};
