...
function Version(store, enckey, signkey, seqnum, verhash, KVs, KEVs) {
...
Version.prototype.getSignedVerhash = function() {
    if (!this._signedVerhash)
        this._signedVerhash = pcrypto.signVerhash(this._enckey,
...
Version.prototype.createNextVersion = function() {
    return new NewVersion({store: this._store, enckey: this._enckey,
...
Version.prototype.createNewVersion = function(signedVerhash) {
    ...
    // instead.
    var out = pcrypto.verifyVerhash(this._enckey, signedVerhash);
...
NewVersion.prototype.close = function() {
    ...
    var nv = new Version(this._store, this._enckey, this._store._signkey,
...
VersionStore.prototype.createFirstVersion = function() {
    var nv = new NewVersion({store: this, enckey: this._enckey, seqnum: 1});
    return nv;
};
VersionStore.prototype.createNewVersion = function(signedVerhash) {
    ...
    var nv = new NewVersion({store: this, enckey: this._enckey,
                             seqnum: out.seqnum,
                             expectedVerhash: out.verhash});
    return nv;
};
