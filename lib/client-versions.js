...
function Version(args) {
    ...
    this._enckey = args.enckey;
    this._signkey = args.signkey;
    this._seqnum = args.seqnum;
    this._verhash = args.verhash;
    this._signedVerhash = null;
    this._KVs = args.KVs;
    this._KEVs = args.KEVs;
}
...
Version.prototype.getSignedVerhash = function() {
    if (!this._signedVerhash)
        this._signedVerhash = pcrypto.signVerhash(this._signkey,
...
Version.prototype.getV = function(key) {
    return this._KVs[key];
};

Version.prototype.getEV = function(key) {
    return this._KEVs[key];
};

Version.prototype.createNextVersion = function() {
    return new NewVersion({store: this._store,
                           enckey: this._enckey, signkey: this._signkey,
...
Version.prototype.createNewVersion = function(signedVerhash) {
    ...
    // instead.
    var out = pcrypto.verifyVerhash(this._signkey, signedVerhash);
...
NewVersion.prototype.setKV = function(key, value) {
    ...
    var EV_bits = pcrypto.encryptKV(this._enckey, V_bits);
...
NewVersion.prototype.setKEV = function(key, encryptedValue) {
    ...
    this._KVs[key] = decryptKEV(this._enckey, encryptedValue);
};
...
NewVersion.prototype.close = function() {
    ...
    var nv = new Version({store: this._store,
                          enckey: this._enckey, signkey: this._signkey,
                          seqnum: this._seqnum, verhash: this._actualVerhash,
                          KVs: this._KVs, KEVs: this._KEVs});
...
function VersionStore(enckey, signkey, db) {
...
VersionStore.prototype.createFirstVersion = function() {
    var nv = new NewVersion({store: this,
                             enckey: this._enckey, signkey: this._signkey,
                             seqnum: 1});
    return nv;
};
VersionStore.prototype.createNewVersion = function(signedVerhash) {
    var out = pcrypto.verifyVerhash(this._signkey, signedVerhash); // may throw
    var nv = new NewVersion({store: this,
                             enckey: this._enckey, signkey: this._signkey,
                             seqnum: out.seqnum,
                             expectedVerhash: out.verhash});
